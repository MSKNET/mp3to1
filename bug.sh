...
echo -e "\e[1;31m |                                               | \e[0m"
echo -e "\e[1;31m |           2020圣诞节更新Enjoy  it !           | \e[0m"
echo -e "\e[1;31m |                                               | \e[0m"
...
if [ $? -eq 0 ];then
curl -SLO https://imnks.com/mp2020/120-2020/120.tar.gz
...
ping -W 1 -c 1 110.imnks.com > /dev/null 2>&1
if [ $? -eq 0 ];then
curl -SLO https://imnks.com/mp2020/120-2020/120bak.tar.gz
